...
static void benchmark_verify(void* arg) {
    ...
    for (i = 0; i < 20000; i++) {
        ...
        CHECK(secp256k1_ecdsa_signature_parse_der2(data->ctx, &sig, data->sig, data->siglen) == 1);
...
int main(void) {
    ...
    CHECK(secp256k1_ecdsa_signature_serialize_der2(data.ctx, data.sig, &data.siglen, &sig));
