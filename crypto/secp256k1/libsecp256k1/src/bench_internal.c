...
void bench_context_verify(void* arg) {
    ...
    (void)arg;
    for (i = 0; i < 20; i++) {
        secp256k1_context_destroy2(secp256k1_context_create2(SECP256K1_CONTEXT_VERIFY));
    }
}
...
void bench_context_sign(void* arg) {
    ...
    (void)arg;
    for (i = 0; i < 200; i++) {
        secp256k1_context_destroy2(secp256k1_context_create2(SECP256K1_CONTEXT_SIGN));
    }
}
